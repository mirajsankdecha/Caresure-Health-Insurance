...
const Review = () => {
  ...
  return (
    <div className="card flex overflow-x-scroll">
      <section className="bg-white body-font rounded border shadow-lg overflow-hidden m-4 w-full">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center border rounded-sm">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <span className="mb-8 leading-relaxed text-lg">
              I have been with Caresure Health Insurance for the past 8 years,
              and have applied for two claims in that time. Both claims got
              settled, and I received good support from the company during my
              hospitalisation.
            </span>
